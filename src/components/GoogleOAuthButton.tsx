...
/**
 * Google OAuth Button Component - Reusable Google Sign-In button
 *
 * This component provides a styled Google OAuth button that can be used
 * in both login and signup forms.
 */
